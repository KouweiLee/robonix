...
def main():
    ...
    action_program_path = os.path.join(
        os.path.dirname(__file__), "grasp.action")
    ...
    try:
        ...
        grasp_object = input("please input object you want to grasp\n")

        runtime.configure_action("grasp", ranger_path="/ranger", object_name = grasp_object)
